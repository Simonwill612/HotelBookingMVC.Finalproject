...
namespace HotelBookingMVC.Finalproject2.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        private readonly UserManager<HotelUser> _userManager; // Add UserManager

        public LoginModel(SignInManager<HotelUser> signInManager, ILogger<LoginModel> logger, UserManager<HotelUser> userManager) // Add UserManager
        {
