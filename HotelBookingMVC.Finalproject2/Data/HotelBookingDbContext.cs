...
namespace HotelBookingMVC.Finalproject2.Data
{
    public class HotelBookingDbContext(DbContextOptions<HotelBookingDbContext> options) : DbContext(options)
    {
        ...
        {
            var connectionString = "Server=LAPTOP-76U18161\\MSSQLSERVERR; Database=HotelBookingDb3Context; User Id=ADMIN; password=P@ssword12345; TrustServerCertificate=True; Trusted_Connection=False; MultipleActiveResultSets=true;";
